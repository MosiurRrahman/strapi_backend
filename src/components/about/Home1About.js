...
const Home1About = () => {
  ...
  const getAboutData = () => {
    GlobalApi.getAbout().then((res) => {
      setAboutData(res.data?.data?.attributes?.about)
    })
  }
const {sub_title,title,description,signature,link,image,counter} = aboutData;
        ...
        <div className="row">
          <div className="col-lg-4 d-lg-flex d-none justify-content-end align-items-start">
            <div className="about-left animet-images magnetic-item pt-30">
              <img src={process.env.NEXT_PUBLIC_STRAPI_API_URL + image?.data[1]?.attributes?.url} alt="" />
            </div>
          </div>
          <div className="col-lg-8">
            <div className="row g-lg-4 gy-5 align-items-xl-center">
              <div className="col-lg-5">
                <div className="about-right-img animet-images magnetic-item">
                  <img src={process.env.NEXT_PUBLIC_STRAPI_API_URL + image?.data[0]?.attributes?.url} alt="" />
                </div>
              </div>
                ...
                <div className="about-content text-animation">
                  ...
                  <div className="signature-and-star text-animation">
                    <div className="signature">
                      <img src={process.env.NEXT_PUBLIC_STRAPI_API_URL + signature?.data?.attributes?.url} alt="" />
                    </div>
                    <div className="star">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
